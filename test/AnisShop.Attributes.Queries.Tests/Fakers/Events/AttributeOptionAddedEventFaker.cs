...
{
    public class AttributeOptionAddedEventFaker
    {
        ...
        public AttributeOptionAddedEventFaker ForAggregate(Guid aggregateId, int version)
        {
        ...
        public AttributeOptionAddedEventFaker WithOption(string key, string arabicLabel, string englishLabel)
        {
            _key = key;
        ...
        public AttributeOptionAdded Generate() => new()
        {
            AggregateId = _aggregateId,
            Version = _version,
            UserId = _faker.Random.Guid().ToString(),
            DateTime = DateTime.UtcNow,
            Data = new AttributeOptionAdded.EventData
            {
